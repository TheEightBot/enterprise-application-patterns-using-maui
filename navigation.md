...
When a view is instantiated, it's associated with its corresponding view model. For more information about how this occurs, see [Automatically creating a view model with a view model locator](#automatically-creating-a-view-model-with-a-view-model-locator).
...
For more information about the Autofac dependency injection container, see [Introduction to dependency injection](#introduction-to-dependency-injection).
